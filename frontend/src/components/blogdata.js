...
import ss1 from "../img/Story/ss1.jpg";
import img2 from "../img/Story/2.png";
import ss2 from "../img/Story/ss2.png";
import img3 from "../img/Story/3.jpg";
import ss3 from "../img/Story/ss3.png";
import img4 from "../img/Story/4.png";
import ss4 from "../img/Story/ss4.png";
import img5 from "../img/Story/5.png";
import ss5 from "../img/Story/ss5.png";
import img6 from "../img/Story/6.png";
import ss6 from "../img/Story/ss6.png";
import img7 from "../img/Story/7.png";
import ss7 from "../img/Story/ss7.png";
import img8 from "../img/Story/8.png";
import ss8 from "../img/Story/ss8.png";
import img9 from "../img/Story/9.png";
import ss9 from "../img/Story/ss9.png";
import img10 from "../img/Story/10.png";
import ss10 from "../img/Story/ss10.png";
import img11 from "../img/Story/11.png";
import ss11 from "../img/Story/ss11.png";
import img12 from "../img/Story/12.png";
import ss12 from "../img/Story/ss12.png";
import img13 from "../img/Story/13.png";
import ss13 from "../img/Story/ss13.png";
import img14 from "../img/Story/14.png";
import ss14 from "../img/Story/ss14.png";
import img15 from "../img/Story/15.png";
import ss15 from "../img/Story/ss15.png";
import img16 from "../img/Story/16.png";
import ss16 from "../img/Story/ss16.png";
import img17 from "../img/Story/17.png";
import ss17 from "../img/Story/ss17.png";
import img18 from "../img/Story/18.png";
import ss18 from "../img/Story/ss18.png";
const images = {
  img1,
  ss1,
  img2,
...
export const stories=[
    ...
    },
    {
      ...
      paraone:"What's the Buzz About Meta AI? Meta AI isn't your typical chatbot—it's the ultimate AI companion. Picture this: it's the life of the AI party, armed with the latest memes, capable of predicting your next pizza craving, and well-versed in all things tech. In essence, Meta AI is like having a brilliant assistant who's always on standby to provide insightful answers to your burning questions, whether you're enjoying your morning coffee or tackling the day's tasks.",
      paratwo:"The Nitty-Gritty Details  Let's delve deeper into what makes Meta AI tick. Powered by a fusion of natural language processing (NLP), deep learning, and a sprinkle of cosmic inspiration, Meta AI is in a league of its own.",
      parathree:"NLP Magic: Meta AI comprehends your queries with unparalleled precision, offering more than just a simple answer—it's like attending a TED Talk on existentialism with every inquiry.Deep Learning Mojo: With Meta AI, learning is a breeze. Think of it as an AI tutor with access to the entirety of human knowledge, ready to assist you at a moment's notice.",
      parafour:"How to Use Meta AI Like a Pro Ready to unlock the full potential of Meta AI? Here's your guide: Engage in Conversations:Strike up a chat with Meta AI on topics ranging from the weather to philosophical ponderings—it's always up for a stimulating discussion.Unleash Creativity:Curious about the next big trend? Meta AI has its finger on the pulse of the universe, ready to provide insights on everything from fashion to cultural phenomena.Decode Cryptic Messages:Received a perplexing message? Meta AI will unravel it quicker than you can blink, providing clarity on even the most enigmatic of texts.Stay Ahead of Trends: Stuck on a creative project? Let Meta AI inspire you with fresh ideas and plot twists that will leave your audience in awe.",
    ...
    },
    {
      ...
      popular: false,
      image:images.img11,
      secondimage:images.ss11,
      publisher: "by Varshita",
      posteddate: "21 March 2024",
      title: "National Creators Award 2024: Recognizing India’s Digital Innovators",
      // quoteby:"– Pedro Domingos",
      intro:"1. The Grand DebutIn a digital landscape teeming with content, a few creators stand out like constellations against the night sky. The National Creators Award 2024 is our ode to these visionaries—the architects who shape our online universe. Let’s delve into the details of this prestigious award and celebrate the minds behind the pixels.",
      paraone:"2. Nominations and Rigorous CriteriaOver 1.5 lakh nominations flooded our servers, each one a testament to passion, persistence, and pixelated brilliance. These nominations spanned multiple categories, from social change advocacy to gaming, education, and beyond. The rigorous evaluation process considered not just popularity but also impact—the ripple effect these creators create in the digital pond.",
      paratwo:"3. The Shortlisted Creators From the bustling streets of Mumbai to the serene hills of Himachal Pradesh, creators from every corner of India they made their mark. The shortlisted creators—200 in total—represent a diverse tapestry of talent. They’re the poets, the educators, the comedians, and the thought leaders. Their content resonates, educates, and entertains.",
      parathree:"4. The Awards Night: Celebrating Excellence Prime Minister Narendra Modi graced the Bharat Mandapam in New Delhi on a crisp March evening. Amidst the grandeur, he honored 23 creators across 20+ categories. These creators aren’t just influencers; they’re change-makers. They wield their digital pens to address societal issues, inspire fitness journeys, and transport us to uncharted realms.",
      // parafour:"Will Devin Replace Human Jobs?",
      parafive:"5. A Glimpse into the Winners’ Circle</br>Jaya Kishori: Best Creator for Social Change. Her videos ignite movements, urging us to look beyond the screen.</br> Kabita Singh (Kabita’s Kitchen): Queen of Food Content. Her recipes? Pure magic.</br> Drew Hicks: International Creator Extraordinaire. His fans span continents.</br> Ranveer Allahbadia (BeerBiceps): Disruptor of the Year. His fitness tips? Legendary.</br> Kamiya Jani: Favourite Travel Creator. She unravels the world, one destination at a time.</br> Maithili Thakur: Cultural Ambassador of The Year. Her melodies bridge generations and cultures.</br>And there’s more—a cultural ambassador, a green champion, a storytelling virtuoso. These creators are the pixels that make us smile, think, and connect. They’re the heartbeat of India’s digital renaissance.",
      conclusion:"In Conclusion: Pixels with Purpose</br>The National Creators Award 2024 isn’t just about accolades; it’s about recognizing the power of pixels. These creators aren’t just shaping content; they’re shaping culture. So, next time you double-tap that Instagram post or binge-watch a YouTube series, remember—the magic lies in the pixels. 🌐✨"
    },
    {
      id: 10,
      popular: true,
      image: images.img10,
      secondimage:images.ss10,
      publisher: "by Varshita",
      posteddate: "15 March 2024",
      title: "Recession in India 2024: A Rollercoaster Ride with a Dash of Curry",
      // quoteby:"– Pedro Domingos",
      intro:"Recession in India 2024: A Rollercoaster Ride with a Dash of Curry: In the throes of a global economic downturn, India finds itself navigating turbulent waters, but with a unique blend of resilience and innovation. As the world grapples with recessionary pressures, India stands firm, its economy resilient amidst the storm. ",
    ...
    },
    {
      ...
      parafour:"4. The Fine Print: Not Just Movie Magic Real-World Applications Beyond Hollywood daydreams, Sora has practical tricks up its sleeve. Imagine teaching physics with animated videos or explaining complex concepts through visual storytelling. Need a virtual tour of ancient ruins? Sora’s got your back. And marketers, listen up: Sora can turn your product descriptions into eye-catching ads. Move over, Don Draper; Sora’s in the house!",
      ...
      conclusion:"*Disclaimer: Sora doesn’t guarantee acceptance to Hogwarts School of Witchcraft and Wizardry.*"
    },
    {
      id: 7,
      popular: false,
      image: images.img7,
      secondimage:images.ss7,
      publisher: "by Varshita",
    ...
    },
    {
      ...
      paratwo:"Seedlings and Saplings: Choosing Your Green Army Time to recruit your plant squad! Head to the seed store (yes, they have tiny uniforms) and pick your warriors. Here’s the lineup:Desi Darlings: Opt for native varieties. They’re like your grandma’s recipes—full of flavor and nostalgia. Desi spinach, carrots, and tomatoes are colorful, delicious, and packed with nutrients. 🥕🍅 Herb Heroes: Basil, mint, and coriander—these herbs are the Avengers of your kitchen garden. They fight blandness, rescue curries, and make your pasta sing. 🌿🎶 Pest Wars: Shielding Your Bounty Ah, pests—the uninvited guests at your veggie feast. Fear not! Here’s your arsenal: Neem Oil Jedi: Mix neem oil with water and spritz it on your plants. Pests hate the smell, and your plants will feel like royalty. 👑 Garlic Guardians: Crush garlic, add water, and create a superhero spray. Bugs flee, and your garden becomes a fortress. 🦗",
